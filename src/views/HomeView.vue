  ...
  >
    ...
    >
      ...
      <div class="basis-1/2 my-auto flex flex-col space-y-3 pt-5 w-full">
        <h1
          class="font-bold text-2xl bg-gray-500/25 backdrop-blur-xl rounded-md p-3"
        >
        ...
        <div v-for="server in servers" :key="server.Name" class="pt-2">
          <div class="pb-1 flex flex-col sm:flex-row sm:space-x-2">
            ...
            <div class="flex space-x-2">
              <span
                class="py-0.5 px-2 bg-gray-500/25 backdrop-blur-xl rounded-xl hover:underline decoration-cyan-500"
          ...
          <div
            class="w-full bg-gray-500/40 backdrop-blur-xl rounded-full p-1 mt-0.5"
          >
            <div
